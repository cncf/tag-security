...
There have been requests from the community to add non-repudiability guarantees to our data (e.g., sequence numbers, signed blobs, other forms of 'audit logging'), and we may elect to expand into this area in the future.
