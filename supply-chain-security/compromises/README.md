...
Additions aren't intended to be a statement on the security stance and/or
practices of any given project, or of open source as a whole. If anything,
many of the stories showcase rapid response, evolving security practices in
the community and an open and transparent approach to disclosure.
...
| [PyPI typosquatting](2019/pypi.md) | 2019 | Naming attack | [1](https://blog.reversinglabs.com/blog/suppy-chain-malware-detecting-malware-in-package-manager-repositories) |
| [ROS build farm compromise](2019/ros.md) | 2019 | Build infrastructure | [1](https://discourse.ros.org/t/security-issue-on-ros-build-farm/9342/8), [2](https://discourse.ros.org/t/new-gpg-keys-deployed-for-packages-ros-org/9454) |
...
| [Canonical's GitHub org compromised](2019/canonical-github.md) | 2019 | Build and publishing infrastructure | [1](https://www.zdnet.com/article/canonical-github-account-hacked-ubuntu-source-code-safe/) |
...
| [RCE in go get -u](2018/gogetu.md) | 2018 | Tooling attack | [1](https://github.com/golang/go/issues/29230), [2](https://staaldraad.github.io/post/2019-03-28-go-get-vuln/) |
...
| [GitHub password recovery issues](2016/gh-unicode.md) | 2016 | SCM | [1](https://bounty.github.com/researchers/jagracey.html), [2](https://eng.getwisdom.io/hacking-github-with-unicode-dotless-i/) |
...
| [APT lack of validation for source packages](2013/apt.md) | 2013 | Build infrastructure | [1](https://lwn.net/Articles/602461/) |
...
| [apache.org incident](2010/apache.md) | 2010 | Build and publishing infrastructure | [1](https://blogs.apache.org/infra/entry/apache_org_04_09_2010) |
...
| [WordPress backdoor](2007/wordpress.md) | 2007 | Source Code Repository | [1](https://lwn.net/Articles/224997/) |
| [SquirrelMail backdoor](2007/squirrelmail.md) | 2007 | Source Code Repository | [1](https://lwn.net/Articles/262688/) |
