...
| ----------------- | ------------------ | ------------------    | ----------- |
| [NPM reverse shells and data mining](2020/nodejs.md) | 2020 | Source Code | [1](https://www.bleepingcomputer.com/news/security/npm-nukes-nodejs-malware-opening-windows-linux-reverse-shells/) |
