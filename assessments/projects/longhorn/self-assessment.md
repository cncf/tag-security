...
| SBOM | The information is not readily available online and we have requested for the same. This is an action item for our subsequent week |
| | |
...
* Longhorn’s commitment to security can be observed in their adherence to these practices, such as using automated testing, code review, and maintaining a public version control repository. More details can be found here: [CII Best Practices](https://longhorn.io/docs/1.5.3/best-practices/)
