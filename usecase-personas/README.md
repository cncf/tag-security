...
* As an enterprise operator, I need a way to nominate per-policy-type operators
...
* A third party system should be able to affect security policy based on assets
